...
public partial class Solver
{
    ...
    private sealed class BruteForceSolverPool
    {
        ...
        public Solver RentCopy(Solver source)
        {
            ...
            if (solver == null)
            {
                ...
                clone.pendingCellForcing.Capacity = Math.Max(clone.pendingCellForcing.Capacity, source.NUM_CELLS);
    ...
    private void CopyBruteForceRuntimeStateFrom(Solver other)
    {
        ...
        pendingCellForcing.Clear();
        for (int i = 0; i < other.pendingCellForcing.Count; i++)
        {
